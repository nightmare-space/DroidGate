...
Java_com_nightmare_droidgate_JNIBridge_sumSquaresNative(JNIEnv *env, jclass clazz, jint n) {
    long long sum = 0;
...
Java_com_nightmare_droidgate_JNIBridge_monteCarloNative(JNIEnv *env, jclass clazz, jint samples) {
    int insideCircle = 0;
...
extern "C"
JNIEXPORT jlong JNICALL
Java_com_nightmare_droidgate_JNIBridge_fibNative(JNIEnv *env, jclass clazz, jint n) {
    if (n <= 1) return n;
    long long a = 0, b = 1;
    for (int i = 2; i <= n; i++) {
        long long t = a + b;
...
Java_com_nightmare_droidgate_JNIBridge_setUid(JNIEnv *env, jclass clazz, jint uid) {
...
Java_com_nightmare_droidgate_JNIBridge_nativeOpen(JNIEnv *env, jobject thiz) {
    return virtual_mouse_open();
}

extern "C"
JNIEXPORT void JNICALL
Java_com_nightmare_droidgate_JNIBridge_nativeMove(JNIEnv *env, jobject thiz, jint dx, jint dy) {
    virtual_mouse_move(dx, dy);
}

extern "C"
JNIEXPORT void JNICALL
Java_com_nightmare_droidgate_JNIBridge_nativeClickLeft(JNIEnv *env, jobject thiz) {
    virtual_mouse_left_click();
}

extern "C"
JNIEXPORT void JNICALL
Java_com_nightmare_droidgate_JNIBridge_nativeClose(JNIEnv *env, jobject thiz) {
    virtual_mouse_close();
}
...
extern "C"
JNIEXPORT jint JNICALL
Java_com_nightmare_droidgate_JNIBridge_nativeMoveMouse(JNIEnv *env, jclass clazz, jint dx, jint dy) {
